...
st.warning("Selected dates not found in data range")
a = (0, 12) # Default to first 12 weeks
```
...
st.dataframe(turnus.head(12), height=450) # Show first 12 weeks as fallback
